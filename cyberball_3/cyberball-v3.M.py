...
title=visual.TextStim(win,text="Bienvenida a la sala 'Lanzamiento de Pelota', una tarea interactiva de visualización mental!", height=1.5, pos=(0,6),color="#000000", wrapWidth=30)
instrText = visual.TextStim(win, text="",height=1, color="#000000", wrapWidth=30)
instrKey = visual.TextStim(win, text="", height=0.8, color="#000000", pos=(0,-7))
